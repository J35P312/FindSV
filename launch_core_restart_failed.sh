...
echo  "SAMPLE_ID":$2
nextflow $FindSV_dir/FindSV_core.nf --bam $2 -c $3 --working_dir $4 --vcf $5 -with-trace $4/trace_annotate.txt | tee $4/log_annotation.txt &
nextflow $FindSV_dir/FindSV_core.nf --bam $1 -c $3 --working_dir $4 -with-trace $4/trace_call.txt | tee $4/log_calling.txt &
wait
